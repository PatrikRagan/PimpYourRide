...
public class ComponentsLists {
	...
	public ComponentsLists() {
		...
		// //guess this is right
		this.bodyKitComponentMap.put("1 0.9 300", new BodyKit(1, 0.9, 300));
		this.bodyKitComponentMap.put("1 1.3 400", new BodyKit(1, 1.3, 400));
		this.bodyKitComponentMap.put("1 1.6 500", new BodyKit(1, 1.6, 500));
		this.bodyKitComponentMap.put("1 1.9 600", new BodyKit(1, 1.9, 600));
		this.bodyKitComponentMap.put("1 2.2 1000", new BodyKit(1, 2.2, 1000));
